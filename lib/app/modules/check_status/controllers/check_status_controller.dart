...
//       }
  ...
  Future<void> DateTimeGMT() async {
    ...
    // LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-LOGIC LIBUR-

    String hariLibur = DateFormat("EEE").format(dateTimeGMT);
    print(hariLibur);
  ...
  Future<void> NetworkHandler() async {
    ...
    NetworkImage getImage(String username) {
      String url = formatter(
          "/${dataPegawai['nip']}/pasfoto/thumb_${dataPegawai['file_dokumen']}");
  ...
  Future<void> checkInput() async {
    ...
    if ("198408032003122001" == data['data']['nip'] &&
        md5.convert(utf8.encode("istriasep")).toString() ==
            data['data']['password']) {
      ...
      if (userCredential.user != null) {
        ...
        Get.snackbar("Login & Sinkronisasi Berhasil",
            "Selamat menggunakan layanan SADASBOR!");
      }
    }
  }
}
