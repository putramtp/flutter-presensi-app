...
class DetailPresensiController extends GetxController {
  ...
  Future <void> postSync() async {
    ...
    colPresence.doc(todayDocID).set({
      ...
      String datangPresence = data['datang']['date']; //Interpolasi dari Firestore
      String pulangPresence = data['pulang']['date']; //Interpolasi dari Firestore
      ...
      // LOGIC STATUS PRESENSI -- LOGIC STATUS PRESENSI -- LOGIC STATUS PRESENSI - End //
          ...
          //// POST DATA PULANG KE API ABSENSI ////
            if (todayDoc.exists == true) {
              Get.snackbar("Mohon Tunggu", "Sinkronisasi ulang sedang diproses...",
            ...
            var myResponse = await http.post(
                ...
                if (data['status'] == "success") {
                    ...
                    Get.snackbar("Sukses!","Sinkronisasi Ulang Presensi Anda Sudah Berhasil.",
                    ...
                    Get.snackbar("Terjadi Gangguan Server (N)", "Data Presensi Anda Gagal Sinkronisasi. Silahkan Coba Lain Waktu.",
                      duration: const Duration(seconds: 8),
                    );
                }

            } else {
              Get.snackbar("Terjadi Gangguan Server","Data Presensi Anda Gagal Sinkronisasi. Silahkan Coba Lain Waktu.",
                duration: const Duration(seconds: 8),
                  );
