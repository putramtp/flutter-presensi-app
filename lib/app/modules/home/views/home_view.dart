        ...
        body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              ...
              String imageSimpeg =
                  "https://simpeg.tasikmalayakab.go.id/assets/media/file/${user['nip']}/pasfoto/thumb_${user['file_dokumen']}";
              return ListView(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      ...
                                      Text(
                                        dataToday?["datang"] == null
                                            ? "-"
                                            : "${DateFormat("HH:mm:ss").format(DateTime.parse(dataToday!['datang']['date']))} WIB",
                                        style: GoogleFonts.poppins(),
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        dataToday?["pulang"] == null
                                            ? "-"
                                            : "${DateFormat("HH:mm:ss").format(DateTime.parse(dataToday!['pulang']['date']))} WIB",
                                        style: GoogleFonts.poppins(),
                                      ),
                                    ],
                                  )
                  ...
                  StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapPresence) {
                        ...
                        if (snapPresence.data?.docs.length == 0 ||
                            snapPresence.data?.docs.length == null) {
                          return SizedBox(
                            height: 60,
                            child: Center(
                              child: Text(
